...
export default function WelcomePage() {
  ...
  return (
    <div className="flex justify-center items-start md:items-center min-h-screen py-0 md:py-4">
      <div className="relative w-full max-w-sm h-screen md:h-[calc(100vh-2rem)] md:max-h-[650px] bg-background text-foreground md:rounded-3xl shadow-2xl overflow-hidden border-background md:border-[10px] md:dark:border-neutral-800">
